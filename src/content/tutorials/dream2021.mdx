...
<img style={{display: "block", margin: "0 auto", width: "70%", maxWidth: "100%", borderRadius: "4px"}} src="/public/assets/images/tutorial/disentangled_example.svg" alt="Disentangled representation example" />
...
<img style={{display: "block", margin: "0 auto", width: "80%", maxWidth: "100%", borderRadius: "4px"}} src="/public/assets/images/tutorial/disentanglement_applications.svg" alt="Disentanglement applications" />
