...
![MICCAI 2023](/assets/images/tutorial/miccai_brain.gif)
*Animation based on [2]*

# News

- 2023-10-09: Slides available [here](/assets/pdfs/Miccai2023_Tutorial_Diffusion_Models_slide_deck.pdf).
...
other complex data types. Diffusion models, in particular, have become a
powerful framework for medical image generation, reconstruction,
denoising, segmentation, anomaly detection, and related tasks.

This tutorial presents an overview of generative modelling with a focus
on diffusion models, including theory, practical training heuristics,
and representative applications in medical imaging. It also includes a
hands-on session built on the open-source [MONAI generative models](https://github.com/Project-MONAI/GenerativeModels)
library.
...
- Mr. Pedro Sanchez is a PhD student at the University of Edinburgh
